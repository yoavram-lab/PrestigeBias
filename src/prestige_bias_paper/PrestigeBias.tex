...
\begin{figure}[t]
  ...
  \begin{subfigure}[a]{0.3\textwidth}
    \includegraphics[width=\linewidth]{../../graphs/chi_square_stats/chi_hist_homogenous_0_01.pdf}
    \subcaption{Error scale is 0.01}
    \end{subfigure}
    \begin{subfigure}[a]{0.3\textwidth}
    \includegraphics[width=\linewidth]{../../graphs/chi_square_stats/chi_hist_homogenous_0_1.pdf} 
    \subcaption{Error scale is 0.1}
    \end{subfigure}
    \begin{subfigure}[a]{0.3\textwidth}
    \includegraphics[width=\linewidth]{../../graphs/chi_square_stats/chi_hist_homogenous_J.pdf}
...
\begin{figure}
    \includegraphics[width=\linewidth]{../../graphs/binary/num_sims.pdf}
...
\begin{figure}
    \includegraphics[width=\linewidth]{../../graphs/binary/full_vs_dm_mutation.pdf}
...
\begin{figure}
    \includegraphics[width=\linewidth]{../../graphs/binary/full_vs_dm_changing_alpha.pdf}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/binary/fix_prob_var_alpha.pdf}
   \end{subfigure}
   \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/binary/fix_time_var_alpha.pdf}
   \end{subfigure}
  \end{center}
...
\begin{figure}[t]
  \begin{center}
  \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/binary/fix_prob_var_beta.pdf}
   \end{subfigure}
   \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/binary/fix_time_var_beta.pdf}
   \end{subfigure}
  \end{center}
...
\paragraph{Proof by induction:} From eq. \ref{eq:expec_freq} we know that
...
\begin{equation}
P_{fix} = \frac{1-e^{-2 S_n N_e x}}{1-e^{-2 S_n N_e}}
\end{equation}
where $S_n = ((k-l)/(k+l))*(1-beta)$, $n=k+l$. Put into words, we use the average selection coefficient of a cycle ($k+l$) as the selection coefficient in our original equation.
...
\begin{figure}[t]
  ...
  \caption{$1-\beta=s=0.005$}
    \includegraphics[width=\linewidth]{../../graphs/changed_env/ch_env_var_alpha.pdf}
   \end{subfigure}
   \begin{subfigure}[a]{0.49\linewidth}
   \caption{$\alpha=0.1$}
    \includegraphics[width=\linewidth]{../../graphs/changed_env/ch_env_var_beta.pdf}
   \end{subfigure}
  \end{center}
...
We then also tried changing the composition of the cycle, by keeping a constant $n$, but changing $k,l$ accordingly.

\begin{figure}[t]
  \begin{center}
  \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/changed_env/ch_env_var_k_div_l.pdf}
   \end{subfigure}
   \begin{subfigure}[a]{0.49\linewidth}
    \includegraphics[width=\linewidth]{../../graphs/changed_env/ch_env_var_k_min_l.pdf}
   \end{subfigure}
  \end{center}
...
In fig.\ref{fig:ch_env_k_l} we see again that the simulations results are mostly above our modified estimation, but still contained in the area between it and the original (constant environment) estimation.
We see that the larger $k$ in relation to $l$, the closer the simulation results to the original estimation.
This was again to be expected - the larger $k$ than $l$, the more time the ideal trait has to be acquired in the population, resulting in a state where the influence alone will accelerate its fixation. So when the cycle reaches the $l$ part, the frequency of the trait is high enough to not be affected by the negative change in the environment, due to the influence.
