...
Prestige bias is also frequency independent (see \Cref{cor:GBD} below), and thus it differs from conformity \citep{anticonformity,Denton2021,conformity}, which depends on the frequency of a trait in the population or in a sample of role-models, rather than the social dynamics of copying.
...
Here, we develop a stochastic model of cultural transmission with both cross-domain indirect success bias and prestige bias to examine their relationship in contribution to the cultural evolution of populations.
We find analytic approximations for this model and analyze its dynamics. We also find approximations for the probability and time to fixation of a `successful' phenotype (i.e., that is subject to success bias). Comparing these approximations to Kimura's approximations for the fixation of a favorable allele \citep{kimura,kimura_average}, we demonstrate that success and prestige bias play the role of natural selection and genetic drift, respectively. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Models}
We begin with a continuous trait model with indirect success bias, previously suggested by Boyd and Richerson~\citep{evolutionBook}. We extend this model to include prestige bias. We then develop a dichotomous trait model. Note that the indirect success bias is due to an indirect evaluation, in which a certain phenotype is used to evaluate the success of potential role-models.
...
We developed a cultural-evolutionary model that includes both indirect success and prestige biases, where the latter is a bias towards role-models with many copiers.
...
Lastly, we examined a scenario in which copiers can adjust their success-weight bias, $\alpha$, to minimize their copying error, i.e., copy trait values closer to the optimal value.
...
Ze Hong~\citep{payoff} studied a model with both frequency-dependent bias (including conformist bias) and payoff bias. The analysis demonstrates that an integrated learning strategy may be superior to relying on either bias alone. Moreover, both biases are likely to contribute to the spread of variants with high payoff, and the magnitude of conformist bias affects the evolutionary dynamics.
% TODO add: 
% Ammar, Madeleine, Laurel Fogarty, and Anne Kandler. 2023. “Social Learning and Memory.” Proceedings of the National Academy of Sciences 120 (33): e2310033120. https://doi.org/10.1073/pnas.2310033120.
% Enquist, Magnus, and Stefano Ghirlanda. 2007. “Evolution of Social Learning Does Not Explain the Origin of Human Cumulative Culture.” Journal of Theoretical Biology 246 (1): 129–35. https://doi.org/10.1016/j.jtbi.2006.12.022.
% Denton, Kaleda K., Yoav Ram, and Marcus W. Feldman. 2022. “Conformity and Content-Biased Cultural Transmission in the Evolution of Altruism.” Theoretical Population Biology 143 (February): 52–61. https://doi.org/10.1016/j.tpb.2021.10.004.
...
\bibitem{Fogarty2017}Fogarty, L., J. Y. Wakano, M. W. Feldman, and K. Aoki. (2017) The driving forces of cultural complexity: Neanderthals, modern humans, and the question of population size. Human Nature : 28: 39-52.
...
\bibitem{payoff} Hong, Ze. (2022) "Combining Conformist and Payoff Bias in Cultural Evolution: An Integrated Model for Human Decision-Making." Human Nature 33.4: 463-484.
