...
Because success may be difficult to estimate, it has been suggested that individuals may indirectly estimate success by using prestige as a proxy for success. Here, we model prestige bias as a combination of indirect success bias and influence bias, the latter meaning that the choice of a role-model depends on the number of individuals that have already copied from that role-model.
...
Our model describes and analyses cultural transmission, especially in human societies where social media is popular.
