...
We also find approximations to the fixation probability and the fixation time of an invading favored (by bias) cultural trait, in both constant and changing environments, which resemble Kimura's approximations for population-genetic models.
