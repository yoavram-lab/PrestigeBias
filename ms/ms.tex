...
We find analytic approximations for this model. We also find approximations for the probability and time to fixation of a `successful' phenotype (i.e., that is subject to success bias) in both a constant and a cyclic changing environment.
