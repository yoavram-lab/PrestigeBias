...
This bias depends on the state of a role-model rather than on its trait, in contrast to frequency biases such as conformity \citep{conformity}, which depend on the frequency of a trait in the population or in a sample of role-models. 
