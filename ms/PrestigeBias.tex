...
\begin{figure}
  ...
  5,000 simulations per data point; population size, $N=1000$; bias weight, $\alpha=0.1$; phenotype values, $\hat{A}=1$,$A=0.7$; $J\sim N(1,x^2)$ where $x$ is the mutation scale in the x-axis. % not clear enough.
  }	
  % TODO
...
% I think this subsection should come before the numerical validation (prev subsection) because the numerical validation also presents Kimura's equation
...
For simplicity, we do not include mutation in this analysis.
