...
\begin{figure}[h]
    ...
    % TODO - black line for 2s as well
...
\begin{figure}[H]
    ...
    % TODO - capital letters for all axis lables
    % letter follows the description (success-bias weight, \alpha
    % show plot of error bars and a scatter for the constant bias weight (no trend)
  \caption{
