...
\begin{titlepage}
	...
	\vspace{1.5cm}
	{\Huge Cultural Evolutionary Dynamics with Success and Influence biases\par}
	\vspace{1.5cm}
	{\large by\par}
...
\begin{figure}[h]
    \includegraphics[width=\linewidth]{../figures/final/GBD_validation.pdf}
  \caption{
...
\begin{figure}[h]
  ...
  The difference between the DM approximation distribution to observed model distribution (a) is very small. The DM approximation (orange) and the simulation results (blue) are almost indistinguishable.
