...
These approximations show that success bias effectively plays the part of natural selection, whereas influence bias effectively reduces the population size. % TODO reduce or increase?
...
Note that here $G_{i,j}$ is only a function of the indicator values $A_j$ and the bias weights $\alpha_j$, as the estimation error is uniform. % TODO correct? anything else need to be assumed?
\end{enumerate}
